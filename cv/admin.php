...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  mysqli_stmt_bind_param($stmt, "ssssssssss", $nama,$deskripsi, $alamat, $telepon, $email, $web, $pendidikan, $pengalaman_kerja, $keterampilan, $foto_path);
  ...
  <!-- <div class="container mt-5"> -->
    <nav class="navbar bg-body-tertiary biru">
      <div class="container-fluid">
        <h1 style="color: black;">Update CV</h1>
        ...
        <div class="card-body">
          <form method="post">
            <div class="mb-3" style="color: black;">
              ...
              <input class="form-control" id="deskripsi" type="text" name="deskripsi" value="<?php echo $data['deskripsi']; ?>" placeholder="Deskripsi" required>
